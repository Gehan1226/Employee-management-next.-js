...
export default function EmployeeTaskSelector() {
  return (
    <>
      ...
      <div className="flex flex-col gap-3 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-md py-2">
        <p className="font-semibold px-2">Selected Employees</p>
        <div className="flex flex-col gap-2 max-h-[500px] overflow-y-scroll p-2">
          <div className="flex flex-col shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-md p-1">
