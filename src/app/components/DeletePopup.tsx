...
export default function DeletePopup({ deleteItemName, closePopup }: Readonly<DeletePopupProps>) {
    return (
        <div className="fixed inset-0 z-50 flex justify-center items-center bg-gray-500 bg-opacity-75 p-5">
            <div className="relative w-full max-w-md max-h-full rounded-lg bg-white shadow-lg z-50 flex flex-col">
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700 p-5">
                    ...
                    <div className="p-4 md:p-5 text-center">
                        ...
                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete <span className='font-semibold'>{deleteItemName}</span> user?</h3>
