...
export default function page() {
  ...
  return (
    <>
      ...
      <div className="
      flex flex-col basis-3/5 h-screen p-6 bg-white border border-white rounded-t-[60px] md:rounded-s-[50px] md:rounded-tr-none shadow-[0px_0px_37px_-1px_rgba(0,_0,_0,_0.7)] justify-between">
